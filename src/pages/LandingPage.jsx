...
const STEPS = [
  { num: '01', title: 'Join the Drop',      desc: 'A claim window opens every hour. Show up fast, grab a trait before the pool empties.' },
        ...
        <div className="hero-grid">
          <div>
            ...
            <p className="hero-lede">
              ...
              Claim hourly traits, compose a portrait, share it on X, unlock your mint.
            </p>
